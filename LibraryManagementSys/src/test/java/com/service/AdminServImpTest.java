...
class AdminServImpTest {
	...
	UsersRepository userrepo;
		...
		void testAddDamagedBooks() {
		 ...
		 @Test void testSearchBookByTitle() 
		  { 
			  Books b1 = new Books(); 
			  b1.setBookid((long)1); 
			  b1.setTitle("FairyTales"); 
		      ...
		      Mockito.when(booksrepo.findBookByTitle("FairyTales")).thenReturn(b1);
		      assertThat(adminservice.searchBookByTitle("FairyTales")).isEqualTo(b1); 
		  }
		  
		  @Test void testSearchBookBySubject() 
		  { 
			  Books b1 = new Books();
		      b1.setBookid((long) 1); 
		      b1.setTitle("FairyTales");
		     ...
		     Mockito.when(booksrepo.findBookBySubject("Cindrella")).thenReturn(b1);
		      assertThat(adminservice.searchBookBySubject("Cindrella")).isEqualTo(b1); }
